eyes, mouth, body = gets.split.map(&:to_i)
keep = 0

if eyes < mouth && eyes < body
  keep = eyes
elsif mouth < body && mouth < eyes
  keep = mouth
elsif body < eyes && body < mouth
  keep = body
end
...
keep_2 = eyes < body ? eyes : body
total_statue = keep + keep_2

puts total_statue


# Hints: তোমাকে তিনটি সংখ্যা দেওয়া হবে। ১ম টি হচ্ছে কয়টি চোখ আছে সেটা, ২য় টি হচ্ছে কয়টি মুখ আছে সেটা এবং সবার শেষে কয়টি শরীর আছে তা দেওয়া থাকবে। তোমাকে বলতে হবে তুমি কয়টি মূর্তি বানাতে পারবে। মূর্তি বানানো যাবে তিন ভাবে –
